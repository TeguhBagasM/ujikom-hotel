...
<head>
    ...
    <title>ADMINISTRATOR THIEV HOTEL</title>
                ...
                <nav class="navbar navbar-expand-md tm-main-nav-container">
                    ...
                    <div class="collapse navbar-collapse tm-main-nav" id="tmMainNav">
                        <ul class="nav nav-fill tm-main-nav-ul">
                            <li class="nav-item"><a class="nav-link" href="teguh_user.php">Data User</a></li>
                            <li class="nav-item"><a class="nav-link" href="teguh_kamar.php">Data Kamar</a></li>
                            <li class="nav-item"><a class="nav-link" href="teguh_tipe_kamar.php">Tipe Kamar</a></li>
                            <li class="nav-item"><a class="nav-link" href="teguh_fasilitas_kamar.php">Fasilitas Kamar</a></li>
                            <li class="nav-item"><a class="nav-link" href="teguh_fasilitas_hotel.php">Fasilitas Hotel</a></li>

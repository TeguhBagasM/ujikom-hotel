                ...
                <nav class="navbar navbar-expand-md tm-main-nav-container">
                    ...
                    <div class="collapse navbar-collapse tm-main-nav" id="tmMainNav">
                        <ul class="nav nav-fill tm-main-nav-ul">
                            <li class="nav-item"><a class="nav-link" href="teguh_index.php">Pesan Kamar</a></li>
                            <li class="nav-item"><a class="nav-link" href="teguh_histori.php">Pesanan Saya</a></li>
                            <li class="nav-item"><a class="nav-link" href="../../teguh_logout_tamu.php" onClick="return confirm('Apakah anda yakin akan logout?');">Logout</a></li>
                        </ul>

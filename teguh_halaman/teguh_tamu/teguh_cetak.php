...
<table width="100%" border="1" cellspacing="0" cellpadding="4">
      ...
      <th>Total</th>
        ...
        <td><?php echo $teguh_cl['teguh_nama_tamu']; ?></td>
        <td><?php echo $teguh_cl['teguh_telpon_tamu']; ?></td>
        <td><?php echo $teguh_cl['teguh_jumlahtamu'] ?></td>
        <td><?php echo $teguh_cl['teguh_chekin'] ?></td>
        <td><?php echo $teguh_cl['teguh_chekout'] ?></td>
        <td><?php echo $teguh_cl['teguh_pesan'] ?></td>
...
<?php
include "../../teguh_koneksi.php";
 $query = mysqli_query($teguh_koneksi, "SELECT * FROM teguh_tamu WHERE teguh_username='$_SESSION[teguh_username]' ");
 $data = mysqli_fetch_array($query); ?>
 <h4 align="right"><?php echo $data['teguh_nama_tamu']; ?></h4>

<br>
<h3><a class="no-print" href="teguh_histori.php" style="margin-right: 3%;">KEMBALI</a>
</body>
</html>
<style type="text/css">
@media print{

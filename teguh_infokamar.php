...
<center><h1 class="tm-blue-text tm-margin-b-p">Info Kamar</h1></center>
<div class="table-responsive">
  ...
  <?php 
      ...
      $teguh_data = mysqli_query($teguh_koneksi,"SELECT * FROM teguh_kamar INNER JOIN teguh_tipe_kamar ON teguh_tipe_kamar.teguh_id_tipe = teguh_kamar.teguh_id_tipe"); 
        ...
        <td>
          <a class="lihat" style="text-decoration: none;" href="teguh_lihatkamar.php?teguh_id_kamar=<?php echo $teguh_dk['teguh_id_kamar']; ?>">Detail</a>
        </td>
            </tr>
            <?php 
        }}else{
        ?>
        <tr>
            <td colspan="5" align="center">Tidak ada kamar yang tersedia</td>
        </tr>
        <?php } ?>
    </table>
